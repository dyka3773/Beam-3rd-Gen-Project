...
info = { # FIXME: This info needs to be updated
    ...
    'date': datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S") # FIXME: This needs to be updated in real time (perhaps do it in JS)
}

def render():
    return render_template('base.html', info=info) # TODO: Create a downlink page